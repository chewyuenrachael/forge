...
const CALENDAR_ITEMS: ContentCalendarItem[] = [
  ...
  { id: 'cc-eu-deadline', date: '2026-08-02', type: 'regulatory', title: 'EU AI Act high-risk provisions effective', description: 'Article 13 transparency requirements become enforceable for high-risk AI systems.' },
  ...
  { id: 'cc-sr117', date: '2026-04-01', type: 'regulatory', title: 'SR 11-7 Compliance for LLMs guide', description: 'Technical guide for banking compliance teams on model risk management.' },
