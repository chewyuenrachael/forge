...
const CAPABILITY_MAP: Record<string, Capability> = {
  'cap-rlfr': { id: 'cap-rlfr', name: 'RLFR', paper_title: 'Features as Rewards', authors: 'Prasad et al.', date: 'Feb 2026', type: 'fundamental', description: '', key_results: ['58% hallucination reduction on Gemma 12B (best-of-32)', '90x cheaper per intervention than LLM-as-judge', 'Tested across 8 domains'], partner_solution: '', readiness: 'production', model_families_tested: [], partners: [] },
  'cap-reasoning-theater': { id: 'cap-reasoning-theater', name: 'Reasoning Theater', paper_title: 'Reasoning Theater', authors: 'Boppana et al.', date: 'Mar 2026', type: 'applied', description: '', key_results: ['68% token savings on MMLU via early exit at 95% probe confidence', '30% token savings on GPQA-Diamond', '80% token savings on easy recall tasks'], partner_solution: '', readiness: 'demo', model_families_tested: [], partners: [] },
  'cap-alzheimers': { id: 'cap-alzheimers', name: "Alzheimer's Biomarkers", paper_title: 'Alzheimer\'s Biomarkers', authors: 'Wang et al.', date: 'Jan 2026', type: 'applied', description: '', key_results: ['Discovered DNA fragment length patterns as novel biomarker class', 'Classifier generalizes better than prior biomarker classes'], partner_solution: '', readiness: 'production', model_families_tested: [], partners: ['Prima Mente', 'University of Oxford'] },
  'cap-rakuten-pii': { id: 'cap-rakuten-pii', name: 'Rakuten PII Detection', paper_title: 'SAE Probes for PII Detection', authors: 'Nguyen et al.', date: 'Oct 2025', type: 'applied', description: '', key_results: ['Deployed across 44M+ users', 'Sub-millisecond inference overhead'], partner_solution: '', readiness: 'production', model_families_tested: [], partners: ['Rakuten'] },
  'cap-model-diff': { id: 'cap-model-diff', name: 'Model Diff Amplification', paper_title: 'Model Diff Amplification', authors: 'Aranguri & McGrath', date: 'Aug 2025', type: 'applied', description: '', key_results: ['Detects rare behaviors occurring once in a million samples'], partner_solution: '', readiness: 'demo', model_families_tested: [], partners: [] },
  'cap-memorization': { id: 'cap-memorization', name: 'Memorization vs Reasoning', paper_title: 'Loss Curvature Analysis', authors: 'Merullo et al.', date: 'Nov 2025', type: 'fundamental', description: '', key_results: ['Removing memorization weights improves reasoning performance'], partner_solution: '', readiness: 'research', model_families_tested: [], partners: [] },
  'cap-spd': { id: 'cap-spd', name: 'SPD', paper_title: 'Scalable Parameter Decomposition', authors: 'Bushnaq et al.', date: 'Jun 2025', type: 'fundamental', description: '', key_results: ['Decomposes model weights into interpretable components'], partner_solution: '', readiness: 'research', model_families_tested: [], partners: [] },
  'cap-evo2-tree': { id: 'cap-evo2-tree', name: 'Evo 2 / Tree of Life', paper_title: 'Finding the Tree of Life in Evo 2', authors: 'Pearce et al.', date: 'Aug 2025', type: 'applied', description: '', key_results: ['Found phylogenetic structure encoded in Evo 2', 'Partnership with Arc Institute'], partner_solution: '', readiness: 'production', model_families_tested: ['Evo 2'], partners: ['Arc Institute'] },
  'cap-interpreting-evo2': { id: 'cap-interpreting-evo2', name: 'Interpreting Evo 2', paper_title: 'Interpreting Evo 2', authors: 'Gorton et al.', date: 'Feb 2025', type: 'applied', description: '', key_results: ['Applied interpretability to next-gen genomic foundation model', 'Partnership with Arc Institute'], partner_solution: '', readiness: 'production', model_families_tested: ['Evo 2'], partners: ['Arc Institute'] },
  'cap-reasoning-hood': { id: 'cap-reasoning-hood', name: 'Under the Hood of Reasoning', paper_title: 'Under the Hood of a Reasoning Model', authors: 'Hazra et al.', date: 'Apr 2025', type: 'fundamental', description: '', key_results: ['Internal analysis of reasoning model processing', 'Reveals mechanisms behind chain-of-thought reasoning'], partner_solution: '', readiness: 'research', model_families_tested: ['DeepSeek R1'], partners: [] },
}
